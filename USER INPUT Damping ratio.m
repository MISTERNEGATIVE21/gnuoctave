...
pkg load control
pkg load signal
# Octave 6.4.0, Wed Mar 30 10:54:16 2022 GMT <unknown@DESKTOP-JSPBQJM>
pkg load control
pkg load signal
# Octave 6.4.0, Fri Apr 01 10:02:24 2022 GMT <unknown@DESKTOP-JSPBQJM>
# Octave 6.4.0, Wed Apr 06 10:10:23 2022 GMT <unknown@DESKTOP-JSPBQJM>
pkg load signal
pkg load control
# Octave 6.4.0, Wed Apr 06 12:09:27 2022 GMT <unknown@DESKTOP-JSPBQJM>
pkg load control
pkg load signal
a=[1 2];
b=[1 -5];
...
[num, den]=zp2tf(z,p,k)
sys=tf(num,den)
# Octave 6.4.0, Fri Apr 08 10:43:59 2022 GMT <unknown@DESKTOP-JSPBQJM>
pkg load signal
[kg load control
pkg load control
# Octave 6.4.0, Wed Apr 20 10:12:38 2022 GMT <unknown@DESKTOP-JSPBQJM>
...
# Octave 6.4.0, Fri Apr 29 10:34:53 2022 GMT <unknown@DESKTOP-JSPBQJM>
# Octave 6.4.0, Wed May 04 11:19:32 2022 GMT <unknown@DESKTOP-JSPBQJM>
# Octave 6.4.0, Fri Apr 29 10:34:53 2022 GMT <unknown@DESKTOP-JSPBQJM>
...
ts=t(xs)
# Octave 6.4.0, Fri May 20 10:40:53 2022 GMT <unknown@DESKTOP-JSPBQJM>
pkg load signal
pkh load control
pkg load control
wn=2*3.14*5
...
# Octave 6.4.0, Wed May 25 10:31:40 2022 GMT <unknown@DESKTOP-JSPBQJM>
pkg load signal
pkg load signal
pkg load control
wn=2*3.14*5
...
for i=1:4
 ...
 sys  =tf(num,den)
 sys1=feedback(sys,1,-1)
#Loop for Input Z( damping Ratio)zai
num=wn*wn
for i= 1:4
 d=input('Damping Ratio')
 den=[1 2*d*wn 0];
